...
{
	public class MainPageWith5PlayersViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<PlayerScore5> _items = new ObservableCollection<PlayerScore5>();
        public ObservableCollection<PlayerScore5> Items
        {
            get { return _items; }
        ...
        private PlayerScore5 ps;
        private static int _turn = 0;

        public MainPageWith5PlayersViewModel(INavigationService navigationService, IPageDialogService dialogService, IEventAggregator eventAggregator)
            : base(navigationService, dialogService, eventAggregator)
        {
            eventAggregator.GetEvent<MessageSentEvent5Players>().Subscribe(MessageReceived);
            eventAggregator.GetEvent<ScoreSentEvent5Players>().Subscribe(ScoreReceived);
            Items = new ObservableCollection<PlayerScore5>();
    ...
    public class PlayerScore5
    {
        ...
        public PlayerScore5(int player1score, int player2score, int player3score, int player4score,
            int player5score)
        {
